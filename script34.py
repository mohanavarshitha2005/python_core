...
# from functools import reduce
# l=['hii','hello','gd','mrg','mam','sir','ammma','nanna','akka']
# print(reduce(lambda x,y:x+y,list(map(lambda x:x.upper(),list(filter(lambda x:len(x)>3,l))))))


# from functools import reduce
# l=[50000,30000,20000,31000,100000,5000]
# print(reduce(lambda x,y:x+y,list(map(lambda x:x+(x*0.15),list(filter(lambda x:x>30000,l))))))
...
# from functools import reduce
# l=[300,500,600,700,515,800]
# print(reduce(lambda x,y:x+y,list(map(lambda x:x-(x*0.1),list(filter(lambda x:x>500,l))))))


# from functools import reduce
# l=[1000,-2000,3000,-9000,10000,50000,15000,-20000]
